...
import { useDeleteParticularQuizMutation } from "../../../features/quizes/quizesApi";

const QuizItem = ({ quiz }) => {
  const navigate = useNavigate();
  const { id, question, video_title } = quiz || {};
  const [deleteParticularQuiz, {}] = useDeleteParticularQuizMutation();
  ...
  return (
    <tr>
      ...
      <td className="table-td flex gap-x-2 justify-center">
        <div className="editBtn" onClick={deleteHandlerFunc}>
          <svg
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth="1.5"
        ...
        <div className="deleteBtn" onClick={editHandlerFunc}>
          <svg
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth="1.5"
